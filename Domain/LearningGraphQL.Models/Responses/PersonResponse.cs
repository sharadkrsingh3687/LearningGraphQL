...
namespace LearningGraphQL.Domain.Models.Responses
{
    ...
    public partial class PersonResponse
    {
        public PersonResponse()
        {
            ...
            EmailAddress = new HashSet<EmailAddressResponse>();
            PersonCreditCard = new HashSet<PersonCreditCardResponse>();
            PersonPhone = new HashSet<PersonPhoneResponse>();
        }
        ...
        public virtual PasswordResponse Password { get; set; }
        ...
        public virtual ICollection<EmailAddressResponse> EmailAddress { get; set; }
        public virtual ICollection<PersonCreditCardResponse> PersonCreditCard { get; set; }
        public virtual ICollection<PersonPhoneResponse> PersonPhone { get; set; }
    }
}