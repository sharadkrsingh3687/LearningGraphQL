...
namespace LearningGraphQL.Domain.Models.Responses
{
    ...
    {
        public SalesOrderHeaderResponse()
        {
            SalesOrderDetail = new HashSet<SalesOrderDetailResponse>();
        ...
        public virtual AddressResponse BillToAddress { get; set; }
        public virtual CreditCardResponse CreditCard { get; set; }
        public virtual CurrencyRateResponse CurrencyRate { get; set; }
        public virtual CustomerResponse Customer { get; set; }
        public virtual SalesPersonResponse SalesPerson { get; set; }
        public virtual ShipMethodResponse ShipMethod { get; set; }
        public virtual AddressResponse ShipToAddress { get; set; }
        public virtual SalesTerritoryResponse Territory { get; set; }
        public virtual ICollection<SalesOrderDetailResponse> SalesOrderDetail { get; set; }
