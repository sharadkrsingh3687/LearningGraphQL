...
namespace LearningGraphQL.Domain.Models.Responses
{
    ...
    public partial class EmployeeResponse
    {
        public EmployeeResponse()
        {
            ...
            EmployeePayHistory = new HashSet<EmployeePayHistoryResponse>();
            JobCandidate = new HashSet<JobCandidateResponse>();
        ...
        public virtual ICollection<EmployeePayHistoryResponse> EmployeePayHistory { get; set; }
        public virtual ICollection<JobCandidateResponse> JobCandidate { get; set; }
